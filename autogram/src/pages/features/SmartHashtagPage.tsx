...
const SmartHashtagPage = () => {
  ...
  const aiHashtagSets = [
    ...
    [
      "#cars", "#carsofinstagram", "#automotive", "#carenthusiast", "#luxurycars",
      "#sportscars", "#supercars", "#carlover", "#cargram", "#instacars",
      "#carculture", "#modifiedcars", "#carphotography", "#driving", "#autolife",
      "#carcommunity", "#fastcars", "#exoticcars", "#carlifestyle", "#caraddict"
    ],
    [
      "#rain", "#rainyday", "#rainvibes", "#monsoon", "#rainfall",
      "#rainyweather", "#rainlover", "#petrichor", "#naturevibes", "#cloudy",
      "#stormyweather", "#raindrops", "#cozyvibes", "#rainyseason", "#naturephotography",
      "#rainydaymood", "#skylover", "#thunderstorm", "#weather", "#moodygrams"
    ]
