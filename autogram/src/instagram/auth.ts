...
// ============================================================
// Instagram Graph API + Facebook OAuth Integration
// ============================================================

// -------------------------------
// 🔐 CONFIGURATION (ADD YOUR KEYS)
// -------------------------------

// 🔴 REPLACE WITH YOUR META APP ID
export const INSTAGRAM_APP_ID = "964260062592662";

// 🔴 REPLACE WITH YOUR META APP SECRET
// ⚠️ IMPORTANT: In production, move this to backend only
export const INSTAGRAM_APP_SECRET = "3209d3b94c9578822dd8a8d3e256ea98";

// 🔴 MUST MATCH EXACTLY what you added in Meta Dashboard
export const INSTAGRAM_REDIRECT_URI = 'http://localhost:8080/auth/callback';

// Graph API base
export const GRAPH_API_BASE_URL = 'https://graph.facebook.com/v19.0';

// Required scopes for posts + insights
export const INSTAGRAM_SCOPES =
  'instagram_basic,pages_show_list,pages_read_engagement,instagram_manage_insights';


// ============================================================
// STEP 1: Generate Facebook OAuth Login URL
// ============================================================
...
// ⚠️ SHOULD RUN SERVER-SIDE IN PRODUCTION
// ============================================================
...
// ============================================================
// STEP 4: Get Facebook Pages Managed by User
// ============================================================

export async function getFacebookPages(accessToken: string) {
  const response = await fetch(
    `${GRAPH_API_BASE_URL}/me/accounts?access_token=${accessToken}`
  );
...
// ============================================================
// STEP 5: Get Instagram Business Account ID From Page
// ============================================================
...
// ============================================================
// STEP 6: Get Instagram Profile Info
// ============================================================
...
export async function getInstagramUserProfile(
  ...
  const fields =
    'id,username,name,account_type,media_count,followers_count,follows_count,profile_picture_url';

  const response = await fetch(
    `${GRAPH_API_BASE_URL}/${igUserId}?fields=${fields}&access_token=${accessToken}`
  );
...
// ============================================================
// STEP 7: Get Instagram Media (Posts)
// ============================================================
...
export async function getInstagramUserMedia(
  ...
  const response = await fetch(
    `${GRAPH_API_BASE_URL}/${igUserId}/media?fields=${fields}&limit=${limit}&access_token=${accessToken}`
  );
